...
const contactActions = {
  whatsapp: { href: "https://wa.me/5547992683132", type: "whatsapp", external: true },
  email: { href: "mailto:brunoeliassantos097@gmail.com", type: "email" }
};
...
const processCopies = {
  en: {
    eyebrow: "Process",
    title: "A craft, not a service",
    subtitle: "How a project moves from a first conversation to a system that earns its keep.",
    progressLabel: "step",
    scrollHint: "scroll →",
    phasePrefix: "phase",
    phaseConnector: "of",
  ...
  de: {
    eyebrow: "Prozess",
    title: "Handwerk, kein Standardservice",
    subtitle: "Wie ein Projekt vom ersten Gespräch zu einem System wird, das seinen Wert liefert.",
    ...
    steps: [
      {
        label: "01 — Discovery",
        title: "Zuhören, abstecken, ausrichten",
        body: "Wir klären Ziel, Zielgruppe und operativen Kontext. Jedes hochwertige Projekt beginnt mit präziser Discovery — nicht mit Annahmen."
      },
      {
        label: "02 — Architektur",
        title: "Das System entwerfen",
        body: "Informationsdesign, Flows, Integrationen und Sonderfälle. Erst kommt ein belastbarer Plan, dann die Umsetzung."
      },
      {
        label: "03 — Umsetzung",
        title: "Mit Absicht bauen",
        body: "Fein abgestimmte Interfaces, saubere Logik und Automationen, die wachsen können. Jede Ebene wird am Ziel geprüft."
      },
      {
        label: "04 — Launch & Entwicklung",
        title: "Veröffentlichen, messen, verbessern",
        body: "Der Launch ist ein Meilenstein, nicht das Ende. Wir messen das Wesentliche und verbessern, sobald echte Daten sprechen."
      }
    ]
  },
  fr: {
    eyebrow: "Processus",
    title: "Un savoir-faire, pas un service générique",
    subtitle: "Comment un projet passe d'une première conversation à un système qui crée de la valeur.",
    progressLabel: "étape",
    scrollHint: "défiler →",
    phasePrefix: "phase",
    phaseConnector: "sur",
    steps: [
      {
        label: "01 — Découverte",
        title: "Écouter, cadrer, aligner",
        body: "Nous clarifions l'objectif, l'audience et le contexte opérationnel. Chaque projet premium commence par une vraie découverte."
      },
      {
        label: "02 — Architecture",
        title: "Concevoir le système",
        body: "Design d'information, parcours, intégrations et cas limites. Un plan solide avant d'expédier le moindre composant."
      },
      {
        label: "03 — Construction",
        title: "Construire avec intention",
        body: "Interfaces soignées, logique propre et automatisations capables de tenir la charge. Chaque couche est revue selon l'objectif."
      },
      {
        label: "04 — Lancement & évolution",
        title: "Livrer, mesurer, affiner",
        body: "Le déploiement est une étape, pas une fin. Nous mesurons ce qui compte et itérons dès que les données arrivent."
      }
    ]
  },
  it: {
    eyebrow: "Processo",
    title: "Artigianalità, non un servizio generico",
    subtitle: "Come un progetto passa dalla prima conversazione a un sistema che genera valore.",
    progressLabel: "step",
    scrollHint: "scorri →",
    phasePrefix: "fase",
    phaseConnector: "di",
    steps: [
      {
        label: "01 — Discovery",
        title: "Ascoltare, definire, allineare",
        body: "Mappiamo obiettivo, pubblico e contesto operativo. Ogni progetto premium parte da una discovery precisa, non da ipotesi."
      },
      {
        label: "02 — Architettura",
        title: "Progettare il sistema",
        body: "Information design, flussi, integrazioni e casi limite. Prima una struttura solida, poi la spedizione dei componenti."
      },
      {
        label: "03 — Costruzione",
        title: "Costruire con intenzione",
        body: "Interfacce curate, logica pulita e automazioni pensate per scalare. Ogni livello viene rivisto rispetto all'obiettivo."
      },
      {
        label: "04 — Lancio & evoluzione",
        title: "Lanciare, misurare, migliorare",
        body: "Il deployment è un traguardo intermedio, non la fine. Misuriamo ciò che conta e iteriamo appena arrivano dati reali."
      }
    ]
  },
  pt: {
    eyebrow: "Processo",
    title: "Um trabalho artesanal, não um serviço comum",
    subtitle: "Como um projeto sai da primeira conversa e vira um sistema que entrega valor de verdade.",
    progressLabel: "etapa",
    scrollHint: "role →",
    phasePrefix: "fase",
    phaseConnector: "de",
    steps: [
      {
        label: "01 — Descoberta",
        title: "Ouvir, mapear, alinhar",
        body: "Mapeamos o objetivo, o público e o contexto operacional. Todo projeto premium começa com descoberta clara, não com suposições."
      },
      {
        label: "02 — Arquitetura",
        title: "Desenhar o sistema",
        body: "Design da informação, fluxos, integrações e casos de borda. Primeiro uma estrutura que sustenta, depois a construção."
      },
      {
        label: "03 — Construção",
        title: "Construir com intenção",
        body: "Interfaces ajustadas à mão, lógica limpa e automações preparadas para escala. Cada camada é revisada contra o objetivo."
      },
      {
        label: "04 — Lançamento & evolução",
        title: "Publicar, medir, refinar",
        body: "O deploy é um marco, não a linha de chegada. Medimos o que importa e iteramos assim que os dados começam a aparecer."
      }
    ]
  }
};
...
const corePortfolio = {
  hero: {
    name: "Bruno Steiger",
    role: "AI · Software · Automation · Digital Systems",
    headline: "I build technology around real business problems.",
    manifesto: "Built through curiosity, practice and a lot of trial and error.",
    subheadline: "AI systems, business automation, CRM, APIs, payment infrastructure, web applications and digital products.",
    badges: ["22 years old", "Based in Brazil", "Open internationally", "Currently learning French"],
    actions: [
      { label: "Explore my work →", href: "#work", variant: "primary" },
      { label: "About me", href: "#about", variant: "secondary" }
    ],
    floatingSignals: ["AI", "API", "DATABASE", "AUTOMATION"]
  },
  about: {
    eyebrow: "Who is Bruno?",
    title: "A builder shaped by real operations.",
    paragraphs: [
      "I’m not someone who learned technology by following a perfect roadmap. My background started around marketing, sales and digital businesses. Working close to real operations made me curious about what was happening behind the tools we used.",
      "That curiosity gradually took me deeper into technology: automation, APIs, databases, AI, CRM systems, front-end, back-end and product development.",
      "Most of what I know came from building things, breaking things, solving problems and learning what was necessary to make the next idea work. I also completed courses and professional training programs inside companies, but practice has always been the center of my development.",
      "I’m naturally reserved. I don’t care much about being the person receiving the credit. I prefer understanding the problem, building something useful and seeing it work.",
      "I’m skeptical of shortcuts and promises of instant success. Real competence takes time. I still have a lot to learn — and that is exactly what keeps me building."
    ],
    highlights: ["22 years old", "Business perspective", "Product thinking", "Technical execution", "Reserved by nature", "Always learning"]
  },
  services: {
    eyebrow: "Capabilities",
    title: "What I can build and connect.",
    subtitle: "Technology is useful when its layers work together. These are the areas I combine to ship complete systems.",
    items: [
      { title: "Build", description: "Front-end, back-end, web applications and product interfaces." },
      { title: "Connect", description: "APIs, webhooks, Meta, WhatsApp and third-party platforms." },
      { title: "Automate", description: "n8n, CRM systems, workflows and operational business logic." },
      { title: "Think", description: "AI agents, qualification systems, LLM workflows and decision layers." },
      { title: "Data", description: "PostgreSQL, Supabase, dashboards and practical data architecture." },
      { title: "Ship", description: "Vercel, Railway, GitHub, VPS, Docker and production delivery." }
    ]
  },
  technologies: {
    eyebrow: "Technology in context",
    title: "Tools connected to outcomes.",
    groups: [
      { title: "Build", tools: ["React", "Next.js", "JavaScript", "Tailwind CSS", "Front-End", "Back-End", "Klumify", "Web Experiences"] },
      { title: "Connect", tools: ["REST APIs", "Webhooks", "Meta API", "WhatsApp API", "Payment Integrations", "Klumify", "Marketing Infrastructure"] },
      { title: "Automate", tools: ["n8n", "CRM", "Workflow Automation", "Lead Routing", "Sales Accelerator", "AI Prospecting"] },
      { title: "Think", tools: ["AI Agents", "LLMs", "Lead Qualification", "Tool Calling", "AI Prospecting", "Customer Service"] },
      { title: "Data", tools: ["PostgreSQL", "Supabase", "Data Architecture", "Dashboards", "Business Logic", "Klumify"] },
      { title: "Ship", tools: ["Vercel", "Railway", "GitHub", "Docker", "VPS", "Production Workflows"] }
    ]
  }
};

function buildContent(copy, locale = "en") {
  return {
    header: {
      logo: "Bruno Steiger",
      ...
      aria: { ...copy.header.aria, home: "Bruno Steiger home" }
    },
    hero: corePortfolio.hero,
    about: corePortfolio.about,
    services: {
      ...corePortfolio.services,
      items: corePortfolio.services.items.map((item, index) => ({ ...item, icon: serviceIcons[index] }))
    },
    process: processCopies[locale] ?? processCopies.en,
    work: {
    ...
    technologies: corePortfolio.technologies,
    contact: {
      eyebrow: copy.contact.eyebrow,
      title: "Let’s build something that deserves to exist.",
      text: "I’m open to product, software, automation and AI opportunities where business context matters as much as technical execution.",
      details: [
        { key: "email", label: "E-mail", value: "brunoeliassantos097@gmail.com" },
        { key: "whatsapp", label: "WhatsApp", value: "+55 47 99268-3132" }
      ],
      actions: [
...
const copies = {
  en: {
    ...
    about: {
      ...
      title: "About Me",
      paragraphs: [
        "I’m Bruno, a 22-year-old Brazilian builder focused on creating modern digital systems.",
    ...
    contact: {
      ...
      details: [
        { key: "name", label: "Name", value: "Bruno Steiger" },
  ...
  de: {
    header: {
      ...
      aria: {
        home: "Startseite von Bruno Steiger",
  ...
  fr: {
    ...
    about: {
      ...
      paragraphs: [
        "Je suis Bruno, un créateur de systèmes brésilien de 22 ans spécialisé dans les solutions digitales modernes.",
    ...
    contact: {
      ...
      details: [
        { key: "name", label: "Nom", value: "Bruno Steiger" },
  ...
  it: {
    ...
    about: {
      ...
      title: "Chi sono",
      paragraphs: [
        "Sono Bruno, un builder brasiliano di 22 anni focalizzato sulla creazione di sistemi digitali moderni.",
    ...
    contact: {
      ...
      details: [
        { key: "name", label: "Nome", value: "Bruno Steiger" },
  ...
  pt: {
    ...
    about: {
      ...
      title: "Sobre mim",
      paragraphs: [
        "Sou Bruno, um construtor de sistemas brasileiro de 22 anos focado em criar soluções digitais modernas.",
...
export const translations = Object.fromEntries(
  Object.entries(copies).map(([locale, copy]) => [locale, buildContent(copy, locale)])
);
