...
const steps = ["Marketing", "Sales", "Digital products", "Paid traffic", "Automation", "CRM", "APIs", "Development", "Databases", "Artificial intelligence", "Complete products"];
    ...
    <section ref={ref} id="learning" className="relative px-5 py-28 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[0.8fr_1.2fr]">
        <SectionReveal className="lg:sticky lg:top-32 lg:self-start">
          <span className="section-eyebrow">How I learn</span>
          <h2 className="mt-2 font-display text-5xl font-bold leading-[0.98] tracking-[-0.05em] text-white sm:text-7xl">Skills that accumulated.</h2>
          <p className="mt-7 max-w-md text-lg leading-8 text-inkSoft">I didn’t replace business skills with technology. Each layer changed how I understand and build the next one.</p>
        </SectionReveal>
