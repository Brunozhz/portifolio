...
export default function DebugMode() {
  ...
  return (
    <div className="debug-mode fixed bottom-5 left-5 z-40 hidden md:block">
      <button type="button" aria-label="Try breaking this site." title="Try breaking this site." onClick={() => setOpen(true)} className="grid h-11 w-11 place-items-center border border-white/10 bg-black/60 text-inkMute backdrop-blur-xl transition hover:border-champagne/35 hover:text-pearl"><Bug className="h-3.5 w-3.5" /></button>
